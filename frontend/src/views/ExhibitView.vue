...
.filter-button {
  @apply px-3 py-1 text-sm rounded-full border transition-all duration-200;
}
...
.filter-button.inactive {
  @apply bg-white border-gray-300 text-gray-600 hover:bg-gray-50;
}
